          ...
          <?php 
            ...
            foreach($result as $row){  ?>
             <tr id="<?php echo $row['id']; ?>">
              ...
              <td><a href="#" data-role="supprimer" data-id="<?php echo $row['id']; ?>">Supprimer</a></td>
             </tr>
          <?php  }
          ?>
      </tbody>
    ...
    $(document).on('click', 'a[data-role=supprimer]',function(){
      ...
      $('#form').submit(function(){
          ...
          if(reponse=='' || nbp =='' || question =='' || choix ==''){
            ...
            $.post('php/Deletequestion.php', {question: question, choix: choix, reponse: reponse, nbp: nbp, id: id}, function(data){
                if(data == 'ok'){
